...
# output directory
dir.output = paste0(project.folder,'plots/ppt/')
...
pdf(paste0(dir.output,'by_state_',dname,'_',time.res,'_1999_2017.pdf'),paper='a4r',width=0,height=0)

for(year in c(1999:2017)){

...
# output directory
dir.output = paste0(project.folder,'plots/wbgt/')
...
pdf(paste0(dir.output,'by_state_',dname,'_',time.res,'_1982_2018.pdf'),paper='a4r',width=0,height=0)

for(year in c(1982:2018)){

...
dir.output = "../../output/grid_county_intersection_raster_prism/"
...
if(space.res=='zip'){
    ...
    us.national = readOGR(dsn=paste0('../../data/shapefiles/zips/tl_2010_',state,'_zcta500'),layer=paste0('tl_2010_',state,'_zcta500'))
